...
5. Раздел `/stocks` из-за недостатка информации (доступна только за один день) и большого количества null-записей возможно унифицировать только созданием SH1-хэша состоящего из сочетания всех полей и помещение его в соответствующее поле `hash_sha1` с помощью insert-триггера.
